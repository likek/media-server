...
import {
  decryptJsonBodyMiddleware,
  decryptUrlMiddleware,
  encryptResponseMiddleware as encryptResponse
} from "./server/middleware/encryptHttp.js";
...
// 解密相关
app.use("/i/", validateFingerprint, validateSalt, decryptUrlMiddleware, decryptJsonBodyMiddleware);
